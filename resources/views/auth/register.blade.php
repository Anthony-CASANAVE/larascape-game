            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-right">{{ __("Token d'enregistrement") }}</label>

                            <div class="col-md-6">
                                <input id="token-test" type="password" class="form-control" name="password_confirmation" required>
                            </div>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn btn-primary">
                                    {{ __('Créer un compte Administrateur') }}
                                </button>
                            </div>
                        </div>
                    </form>
